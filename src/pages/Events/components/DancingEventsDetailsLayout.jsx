...
export default function DancingEventsDetailsLayout({data, index}) {
  ...
  return (
    <PageLayout 
      ...
      breadcrumbs={[
        ...
        { label: "DancingEvents", path: "/events/dancingevents" },
        { label: data["Event Name"], path: `/events/dancingevents/${index}` }
      ]}
    >
