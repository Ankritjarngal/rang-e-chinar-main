...
function About() {
  ...
  // Spring-themed background color and decoration
  const lightSpringBg = "bg-[#EAF8F0]"; // Light pastel green
  const springDecorativeStyle = {
    backgroundImage: "url('/spring/blossom.png')",
  ...
  return (
    <div className='px-4 sm:px-0 flex justify-center items-center relative font-playfair'>
      ...
      <div
        style={{ ...springDecorativeStyle, width: "60px", height: "80px", position: "absolute", top: "0", left: "0" }}
      ></div>
      <div
        style={{ ...springDecorativeStyle, width: "60px", height: "80px", position: "absolute", bottom: "0", right: "0" }}
      ></div>
      <div
        data-aos="fade-down"
        className={`p-8 my-40 ${lightSpringBg} sm:p-12 md:w-3/5 sm:w-4/5 rounded-lg border-l-2 border-t-2 border-primary`}
      >
        <div className='overflow-visible mb-5'>
          <p className='text-sm sm:text-base font-semibold text-green-600 font-quicksand'>
            NIT Srinagar's Annual Cultural Festival
          </p>
          <h2 className='text-primary text-5xl sm:text-6xl md:text-7xl overflow-visible font-bold font-playfair mt-2 tracking-wider'>
            Rang-E-Chinar
          </h2>
        </div>
        <div>
        ...
        {/* Spring decorative blossom divider */}
        <div className="flex justify-center mt-8">
          <div
            style={{ ...springDecorativeStyle, width: "60px", height: "20px" }}
          ></div>
        </div>
      </div>
    </div>
